...
\newcommand{\appm}{\mathop{\hat{\oldapp}}}
\newcommand{\Pii}{\tilde{\Pi}}
\newcommand{\appi}{\mathop{\tilde{\oldapp}}}
\newcommand{\Id}{\mathsf{Id}}
\newcommand{\reflect}{\mathsf{reflect}}

% object theory: universal IIT with Prop-sorts
%\newcommand{\prop}[1]{\overline{#1}}
\newcommand{\prop}[1]{{\color{BrickRed}#1}}
\newcommand{\Typ}{\prop{\mathsf{Ty}}}
\newcommand{\Tmp}{\prop{\mathsf{Tm}}}
\renewcommand{\sp}[2]{#1\prop{[}#2\prop{]}}
\newcommand{\extp}{\mathop{\prop{\rhd}}}
\newcommand{\commap}{\mathop{\prop{,}}}
\newcommand{\pp}{\prop{\mathsf{p}}}
\newcommand{\qp}{\prop{\mathsf{q}}}
\newcommand{\Up}{\prop{\mathsf{U}}}
\newcommand{\Elp}{\prop{\mathsf{El}}}
\newcommand{\Pip}{\prop{\Pi}}
\newcommand{\appp}{\prop{\mathsf{app}}}
\newcommand{\Pipp}{\prop{\prop{\Pi'}}}
\newcommand{\apppp}{\prop{\prop{\mathsf{app'}}}}
\newcommand{\Pimp}{\prop{\hat{\Pi}}}
\newcommand{\appmp}{\mathop{\prop{\hat{\oldapp}}}}
\newcommand{\Piip}{\prop{\tilde{\Pi}}}
\newcommand{\appip}{\mathop{\prop{\tilde{\oldapp}}}}


% untyped syntax
\newcommand{\untyp}[1]{{#1}^p}
