...
that uses it is in the type preservation proof for identity substitutions (this
...
heavyweight:
\[
  \mathsf{PartialMap}\,A\,B := A\ra (P : \Set)\times\isaprop\,P\times (P \ra B)
\]
...
convenience, since the former are natively supported in type theory, while the
...
well-typed context, type or term.  Everything is done by induction on the typing
judgments.
