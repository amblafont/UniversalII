...
\,(A[\sigma])\,(B[\varu\, \mathsf{0} \,\consu\, \wkO\,\sigma])$, and thus we need to define
...
the $\Piu$ type: indeed, we want to define $\wkO\,(\Piu\,A\,B)$ as the $\Pi$ type
...
first projection of these constructions yield a model morphism from the syntax
to the model.
