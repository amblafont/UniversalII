...
\model{\Gamma})\times (\rec\,A = \model{A})$ (note that the first equality is
...
are contractible, i.e., have a unique inhabitant. The first step consists in showing that these types are propositions.
