...
\begin{abstract}
  xxx: rewrite. Inductive-inductive types (IITs) are a generalisation of inductive types in
...
\item \Cref{sec:constructingiits}. We show that if a model of ETT
  ...
  sense: \Cref{thm:ToSToIITs}. This is an adaptation of a proof in
...
of \Cref{thm:ToSToIITs}, all IITs. For this, we work in the internal
