...
index disambiguates different sorts. An example is the predicates (or \emph{indexed sorts})
...
where the variable $\Gamma$ is implicitly universally quantified when required
(we indeed sometimes omit universal quantification in the following, for readability),
\begin{alignat*}{5}
  & \Con^D && : \Con\ra\Set \\
...
this notion would be deduced. Hence, we give an ad-hoc definition for
