...
\Copyright{Ambrus Kaposi, Andr{\'a}s Kov{\'a}cs and Ambroise Lafont}%TODO mandatory, please use full first names. LIPIcs license is "CC-BY";  http://creativecommons.org/licenses/by/3.0/
...
\item \Cref{sec:constructingiits}. In \Cref{thm:ToSToIITs}, we show that if a
  ...
  (\Cref{def:theoryofsignatures}), then it supports IITs. This is an adaptation of a proof in
