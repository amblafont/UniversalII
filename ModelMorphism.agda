...
record ModelMorphism {ℓ₁} {ℓ₂} (A : Model {ℓ₁}) (B : Model {ℓ₂}) : Set (lmax ℓ₁ ℓ₂)  where
  -- infixl 5 _▶_
  -- infixl 5 _^^_
  module M = Model A
  module N = Model B
  ...
  field
    ...
    l-subtᴹ : ∀ {Γ : M.Con}{E : M.Ty Γ}{Δ : M.Telescope (Γ M.▶ E)} {z : M.Tm Γ E}
      ...
      Tmᴹ (M.l-subt E Δ z A t) ≡
        N.tr2-Tm⁻¹ ^^subTelᴹ
          (N.tr-Tm (! (transpose-tr _ _ l-subTᴹ ))
            (N.l-subt (Tyᴹ E)
