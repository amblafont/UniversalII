...
m2 : UnivΠMor syntaxUnivΠ M.RewUnivΠ m1
m2 = record { univmor =
  record { Uʳ = refl ; Elʳ = refl } ;
  Πmor = record { Πʳ = refl ; $ʳ = (λ  {Γ} {a} {B} t u →  $ʳ t u    ) } }
  {- 
